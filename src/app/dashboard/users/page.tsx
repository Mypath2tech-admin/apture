    ...
    const fetchUsers = async () => {
      ...
      const toggleDashboardAccess = async (userId: string, currentValue: boolean) => {
        ...
        try {
          ...
          setUsers(users.map((user) => (user.id === userId ? { ...user, canViewOrgDashboard: !currentValue } : user)))
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              orgUser.isActive ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                            }`}
                          >
                            ...
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 text-sm text-gray-500 flex items-center">
                                {orgUser.canViewOrgDashboard ? (
                                  <>
                                    <Eye className="h-4 w-4 text-green-600 mr-1" /> Can view
                                  </>
                                ) : (
                                  <>
